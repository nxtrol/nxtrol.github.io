...
You can move a toolbar by clicking on its left border and then dragging and dropping it to 
...
You can undock any window from its default location in LogicLab and move it anywhere , 

just click on its title bar and drag it to the location you want.
